                ...
                <table className="w-full">
                  <thead>
                    <tr className="bg-[#005BAC] text-white">
                      <th className="py-3 px-4 text-left text-sm">利用時間帯</th>
                      <th className="py-3 px-4 text-left text-sm">料金（1時間あたり）</th>
                      <th className="py-3 px-4 text-left text-sm">5人利用時（1人あたり）</th>
                    </tr>
                  </thead>
                  <tbody>
                    {weekdayPrices.map((item, index) => (
                      ...
                      >
                        <td className="py-3 px-4 border-b border-gray-100 text-sm">{item.time}</td>
                        <td className="py-3 px-4 border-b border-gray-100 font-bold text-sm">{item.price}</td>
                        <td className="py-3 px-4 border-b border-gray-100 text-gray-600 text-sm">{item.perPerson}</td>
                      </motion.tr>
                    ))}
                  </tbody>
                </table>
      ...
      <div className="mt-6 bg-[#F3EFE9]/30 p-5 rounded-lg">
        ...
        <ul className="space-y-2">
          <li className="flex items-start">
            ...
            <span className="text-sm text-gray-700">高品質音響システム（BOSE製スピーカー）</span>
          </li>
          <li className="flex items-start">
            <Check className="mr-2 h-4 w-4 text-[#005BAC] flex-shrink-0 mt-0.5" />
            <span className="text-sm text-gray-700">プロ仕様の全面鏡</span>
          </li>
          <li className="flex items-start">
            <Check className="mr-2 h-4 w-4 text-[#005BAC] flex-shrink-0 mt-0.5" />
            <span className="text-sm text-gray-700">冷暖房完備</span>
          </li>
          <li className="flex items-start">
            <Check className="mr-2 h-4 w-4 text-[#005BAC] flex-shrink-0 mt-0.5" />
            <span className="text-sm text-gray-700">Wi-Fi無料</span>
          </li>
        </ul>
      </div>
    </div>
